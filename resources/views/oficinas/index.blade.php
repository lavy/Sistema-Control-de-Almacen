    ...
    <div class="container">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                {!!Form::open(['url'=>'oficina','method'=>'GET','class'=>'navbar-form navbar-left pull-right','role'=>'search'])!!}
                ...
                {!!link_to('crear_oficinas','Crear Nueva Oficina',['class'=>'btn btn-primary'])!!}
                 ...
                 <p>Hay {{$oficinas->total()}} Oficinas</p>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($oficinas as $oficina )
                        <tr id="s">
                            <td id='d' style="text-align:center;">{{$oficina->id_oficina}}</td>
